    ...
    <div class="section-body">
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="main/updatependuduk/<?= $id; ?>" enctype="multipart/form-data" id="save" method="post">
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <select name="statuskawin" class="form-control" id="">
                    <option value="">Pilih</option>
                    <option value="Belum Kawin" <?php if ($row->statuskawin == 'Belum Kawin') echo 'selected' ?>>Belum Kawin</option>
                    <option value="Kawin" <?php if ($row->statuskawin == 'Kawin') echo 'selected' ?>>Kawin</option>
                    <option value="Cerai Hidup" <?php if ($row->statuskawin == 'Cerai Hidup') echo 'selected' ?>>Cerai Hidup</option>
                    <option value="Cerai Mati" <?php if ($row->statuskawin == 'Cerai Mati') echo 'selected' ?>>Cerai Mati</option>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <center> <img id="blah" class='img-fluid mb-3' width='280' src="image/<?php echo $row->foto ?>" alt="your image" /></center>
