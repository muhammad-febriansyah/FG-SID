     ...
     <div class="section-body">
       ...
       <div class="col-12">
         <div class="card">
           ...
           <div class="card-body">
             <form action="main/savependuduk" id="save" enctype="multipart/form-data" method="post">
               ...
               <div class="form-group row mb-4">
                 ...
                 <div class="col-sm-12 col-md-7">
                   <center> <img id="blah" class='img-fluid mb-3' width='280' src="assets/nofoto.jpg" alt="your image" /></center>
