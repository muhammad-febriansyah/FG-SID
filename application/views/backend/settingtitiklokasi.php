                    ...
                    <form action="main/updatetitiklokasi" id="save" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="lat" id="Latitude" value="<?php echo $setting->lat ?>" type="text"
                                ...
                                <td>
                                    <input name="lng" id="Longitude" value="<?php echo $setting->lng ?>" type="text"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="reset" class="btn btn-danger btn-sm"><i class="fa fa-sync-alt"></i>
                                        Batal</button>
                                </td>
                            </tr>
                        </table>
