        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <?php if ($this->session->userdata("level") == "1") { ?>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="nav-link" href="main/struktur">Struktur Organisasi</a></li>
                  <li><a class="nav-link" href="main/bpd">BPD</a></li>
                </ul>
              </li>
            ...
            <li class="dropdown">
              ...
              <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="dollar-sign"></i><span>Transparansi Anggaran</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="main/apbd">APBDes Tahun</a></li>
                  <li><a class="nav-link" href="main/inputapbd">Input APBDes Tahun</a></li>
                </ul>
              </li>
              ...
              <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="map"></i><span>Irigasi Dan Lahan</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="main/mapirigasi" target="_blank"> Maps Lahan & Irigasi</a></li>

                  <li><a class="nav-link" href="main/lahan"> Data Lahan</a></li>
                  <li><a class="nav-link" href="main/inputlahan1"> Input Lahan</a></li>
                  <li><a class="nav-link" href="main/irigasi"> Data Irigasi</a></li>
                  <li><a class="nav-link" href="main/inputlahan"> Input Irigasi</a></li>
                </ul>
              </li>
              <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="map"></i><span>Gis Pembangunan Desa</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="main/mapkegiatanfisik" target="_blank">Maps Kegiatan Fisik</a></li>
                  <li><a class="nav-link" href="main/sumberdana"> Sumber Dana</a></li>
                  <li><a class="nav-link" href="main/jeniskegiatan">Jenis Kegiatan</a></li>
                  <li><a class="nav-link" href="main/kegiatanfisik"> Kegiatan Fisik</a></li>
                  <li><a class="nav-link" href="main/inputkegiatanfisik">Input Kegiatan Fisik</a></li>
                </ul>
              </li>
              ...
              <li class="dropdown">
                <a href="main/profil" class="nav-link"><i data-feather="key"></i><span>Ubah password</span></a>
              </li>
              <li class="dropdown">
