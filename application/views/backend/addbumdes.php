                        ...
                        <form action="main/savebumdes" id="save" method="post" enctype="multipart/form-data">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input type="text" placeholder="Kategori Produk" class="form-control"
                                            autocomplete="off" name="kat">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Harga Produk</td>
                                    <td colspan="3">
                                        <input type="text" placeholder="Harga Produk" class="form-control uang"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input type="number" placeholder="No. Handphone BUMDES" class="form-control"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge badge-warning mb-3"><strong>Informasi</strong> Input Gambar
                                            Maksimal 2mb !</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="reset" class="btn btn-danger btn-sm"><i
                                                class="fa fa-sync-alt"></i> Batal</button>
                                    </td>
                                </tr>
                            </table>
                        </form>
