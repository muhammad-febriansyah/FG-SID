...
class Main extends CI_Controller
{
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td><?php echo $no; ?></td>
                        <td>
                            <img src="image/<?php echo $row->foto ?>" width="100" alt="" class="img rounded-circle">
                        </td>
    ...
    public function savependuduk()
    {
        ...
        if ($this->upload->do_upload("gambar")) { //upload file
            ...
            $result = $this->db->query("insert into penduduk values('','$nama','$jk','$tempatlahir','$tgllahir','$umur','$statuskawin','$warganegara',
            '$agama','$pendidikan','$nik','$rt','$rw','$dusun','$nokk',now(),'$alamat','0','$gambar'
            )");
            // echo true;
    ...
    public function updatependuduk($id = '')
    {
        ...
        if (!empty($_FILES['gambar']['name'])) {
            if (!$this->upload->do_upload('gambar')) {
                ...
                warganegara='$warganegara',agama='$agama',pendidikan='$pendidikan',nik='$nik',rt='$rt',rw='$rw',dusun='$dusun',nokk='$nokk',alamat='$alamat',foto='$gambar' where id='$id'
                ");
...
<?php  }
    ...
    public function saveprofile()
    {
        ...
        if($password != ""){
            $this->db->query("UPDATE admin set nama='$nama',username='$username',password=md5(md5(md5('$password'))) where id='$id'");
        }else{
